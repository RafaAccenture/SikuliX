...
public class PrimalWindow {
	...
	/**
	 * Busca el icono de cierre y cierra la ventana n veces seg�n el n�mero de iteraciones especificadas
	 * @param iterations
	 * @param timeBetween
	 * @throws FindFailed
	 */
	public void closeWindow(int iterations, int timeBetween) throws FindFailed {
		...
		while(iterations>0) {
			...
			if(WaitFor("Cerrando la ventana numero "+iterations,
				...
				System.err.println("no se encuentra el bot�n de cerrar ventana");
				break;
			}
